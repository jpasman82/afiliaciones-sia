...
//  Diseñado para reusar tu estado actual:
//   - formData            (tu useState)
//   - onChange = handleChange (event-based, igual al tuyo)
//   - onSubmit = guardarFicha
//  El bloque DNI recibe callbacks para enganchar tu EscanerDocumento.
// ============================================================================
  ...
  return (
    <form onSubmit={onSubmit} className="max-w-4xl mx-auto pb-24 md:pb-8" data-screen-label={editando ? 'Editar ficha' : 'Nueva ficha'}>
      ...
      <Card className="px-5 md:px-7 divide-y divide-slate-100">
        ...
        <FormSection n="2" title="Documentación" sub="DNI: frente y dorso, o un archivo único">
          <DniUploader dni={dni} />
        </FormSection>
